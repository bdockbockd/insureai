...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "auth.loginSubtitle": "Sign in to access your personalized insurance chats",
    "auth.registerSubtitle": "Join InsureAI for personalized insurance recommendations",
    "auth.name": "Name",
    ...
    "auth.loginAfterRegisterFailed": "Account created but login failed. Please sign in manually.",
    "auth.genericError": "An error occurred. Please try again.",
    "auth.benefits": "Save your chats, track plans, and connect with agents",
    "auth.myChats": "My Chats",
  ...
  th: {
    ...
    "auth.loginSubtitle": "เข้าสู่ระบบเพื่อเข้าถึงแชทประกันส่วนตัวของคุณ",
    "auth.registerSubtitle": "เข้าร่วม InsureAI เพื่อรับคำแนะนำประกันส่วนบุคคล",
    "auth.name": "ชื่อ",
    ...
    "auth.noAccount": "ยังไม่มีบัญชี? สมัครสมาชิก",
    ...
    "auth.registerFailed": "การลงทะเบียนล้มเหลว กรุณาลองใหม่",
    "auth.loginAfterRegisterFailed": "สร้างบัญชีสำเร็จแต่เข้าสู่ระบบล้มเหลว กรุณาเข้าสู่ระบบด้วยตนเอง",
    "auth.genericError": "เกิดข้อผิดพลาด กรุณาลองใหม่",
    "auth.benefits": "บันทึกแชท ติดตามแผน และติดต่อตัวแทน",
    "auth.myChats": "แชทของฉัน",
