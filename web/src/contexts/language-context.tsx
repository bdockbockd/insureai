...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "auth.whyLogin": "Why Create an Account?",
    "auth.ssoSubtitle": "Sign in with your social account to get started",
    "auth.continueWithGoogle": "Continue with Google",
    "auth.continueWithFacebook": "Continue with Facebook",
    "auth.benefit1Title": "Unlimited AI Consultations",
    "auth.benefit1Desc": "Ask our AI advisor anything about insurance, anytime",
    "auth.benefit2Title": "Community Access",
    "auth.benefit2Desc": "Join discussions, share experiences, and learn from others",
    "auth.benefit3Title": "Expert Consultation",
    "auth.benefit3Desc": "Connect with licensed insurance advisors for personalized help",
    "auth.guestMode": "Try Before You Sign Up",
    "auth.guestModeDesc": "Guests can use 3 free AI chats per day. Login for unlimited access.",
    "auth.termsText": "By continuing, you agree to our Terms of Service and Privacy Policy",
    "auth.feature1": "Save chat history",
    "auth.feature2": "Track applications",
    "auth.feature3": "Priority support",
    "auth.feature4": "Exclusive offers",
  ...
  th: {
    ...
    "auth.whyLogin": "ทำไมต้องสมัครสมาชิก?",
    "auth.ssoSubtitle": "เข้าสู่ระบบด้วยบัญชีโซเชียลของคุณเพื่อเริ่มต้น",
    "auth.continueWithGoogle": "ดำเนินการต่อด้วย Google",
    "auth.continueWithFacebook": "ดำเนินการต่อด้วย Facebook",
    "auth.benefit1Title": "ถาม AI ได้ไม่จำกัด",
    "auth.benefit1Desc": "ถาม AI ที่ปรึกษาประกันได้ทุกเรื่อง ทุกเวลา",
    "auth.benefit2Title": "เข้าถึงชุมชน",
    "auth.benefit2Desc": "ร่วมพูดคุย แบ่งปันประสบการณ์ และเรียนรู้จากผู้อื่น",
    "auth.benefit3Title": "ปรึกษาผู้เชี่ยวชาญ",
    "auth.benefit3Desc": "ติดต่อที่ปรึกษาประกันที่มีใบอนุญาตเพื่อรับความช่วยเหลือ",
    "auth.guestMode": "ลองใช้ก่อนสมัคร",
    "auth.guestModeDesc": "แขกสามารถใช้ AI แชทฟรี 3 ครั้งต่อวัน เข้าสู่ระบบเพื่อใช้งานไม่จำกัด",
    "auth.termsText": "การดำเนินการต่อถือว่าคุณยอมรับข้อกำหนดการใช้งานและนโยบายความเป็นส่วนตัว",
    "auth.feature1": "บันทึกประวัติแชท",
    "auth.feature2": "ติดตามใบสมัคร",
    "auth.feature3": "รับการสนับสนุนพิเศษ",
    "auth.feature4": "ข้อเสนอพิเศษ",
