                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <CardContent className="p-6 sm:p-10 flex flex-col justify-center">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
                      {language === "th" && featuredPost.titleTh
                        ? featuredPost.titleTh
                        : featuredPost.title}
                    </h2>
                    <p className="text-gray-600 mb-5 leading-relaxed">
                      {language === "th" && featuredPost.excerptTh
                        ? featuredPost.excerptTh
                ...
                <Card hover className="h-full overflow-hidden shadow-md">
                  ...
                  <CardContent className="p-6">
                    ...
                    <h3 className="font-bold text-lg text-gray-900 mb-3 line-clamp-2">
                      {language === "th" && post.titleTh
                        ? post.titleTh
                        : post.title}
                    </h3>
                    <p className="text-gray-600 text-sm mb-5 line-clamp-2 leading-relaxed">
                      {language === "th" && post.excerptTh
                        ? post.excerptTh
                        : post.excerpt}
                    </p>
